  ...
  return (
    <React.Fragment>
      ...
      <div ref={myRef}>
        <HomeArticle
          image={Heading1}
          text="При виявленні звуку пристрій записуватиме його для подальшої обробки."
        />
        <HomeArticle
          image={Heading2}
          text="На закритій платформі відображатимуться повідомлення про виявлену агресію."
          reverse
        />
        <HomeArticle
          image={Heading3}
          text="Поліція приїжджатиме для вчасного вживання заходів (до повторного випадку скоєння акту насилля)."
        />
      </div>
      <Footer />
    </React.Fragment>
